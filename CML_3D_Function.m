function [outputArg1] = CML_3D_Function(i,n,initvalue)
% clear
% i =10; %% 格子数
% n = 100;  %% 迭代次数
outputArg1 =zeros(i,n);
% [outputArg_row,outputArg_col]=size(outputArg);
mapping_result = outputArg1;
%%  cml_3d
%% 赋值
mapping_result(1,1)=initvalue(1,1);   %0.1;
mapping_result(2,1)=initvalue(2,1);   %0.2;
mapping_result(3,1)=initvalue(3,1);   %0.3;
mapping_result(4,1)=initvalue(4,1);  %0.5;
mapping_result(5,1)=initvalue(5,1);   %0.6;
